...
data class RemoteSale(
    ...
    @SerialName("account_id") val accountId: String? = null,
    val notes: String? = null,
    @SerialName("vat_refund_percent") @Serializable(with = BigDecimalSerializer::class) val vatRefundPercent: BigDecimal? = null,
    @SerialName("vat_refund_amount") @Serializable(with = BigDecimalSerializer::class) val vatRefundAmount: BigDecimal? = null,
    ...
    @SerialName("jurisdiction_type") val jurisdictionType: String? = null,
    @SerialName("jurisdiction_code") val jurisdictionCode: String? = null,
    @SerialName("out_the_door_total") @Serializable(with = BigDecimalSerializer::class) val outTheDoorTotal: BigDecimal? = null,
    @SerialName("cash_received_now") @Serializable(with = BigDecimalSerializer::class) val cashReceivedNow: BigDecimal? = null,
    @SerialName("amount_financed") @Serializable(with = BigDecimalSerializer::class) val amountFinanced: BigDecimal? = null,
    @SerialName("monthly_payment_estimate") @Serializable(with = BigDecimalSerializer::class) val monthlyPaymentEstimate: BigDecimal? = null,
    @SerialName("created_at") val createdAt: String,
    @SerialName("updated_at") val updatedAt: String,
    @SerialName("deleted_at") val deletedAt: String? = null
)
